...
public class autocloth : MonoBehaviour
{
    ...
    IEnumerator generatecloth()
    {
        ...
        // solveroriginal.AddComponent<ObiSolver>();   
            ...
            tmp.Solver.tetherConstraintParameters.iterations = 1;
            ...
            tmp.Solver.distanceConstraintParameters.iterations = 8;     // higher iteration higher stiffness
            tmp.Solver.bendingConstraintParameters.iterations = 1;  // higher iteration higher stiffness
            tmp.Solver.shapeMatchingConstraintParameters.iterations = 3;
            tmp.Solver.collisionConstraintParameters.iterations = 4;
            tmp.Solver.shapeMatchingConstraintParameters.iterations = 1;
            tmp.Solver.stitchConstraintParameters.iterations = 1;
            tmp.Solver.particleCollisionConstraintParameters.iterations = 3;
            tmp.Solver.pinConstraintParameters.iterations = 2;     // pin constraints for particle
            tmp.Solver.substeps = 3;  //improve substeps for a better quality than manual setting
            //  tmp.Solver.
