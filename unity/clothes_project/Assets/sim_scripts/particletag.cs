    ...
    public class particletag : MonoBehaviour
    {
       ...
       IEnumerator wait_bending()
        ...
        void kdtreesearch()
        {
            ...
            particleindexsphere[0] = tree.FindNearestsK(twoobject[0].transform.position, 16);  // find nearst 16
            particleindexsphere[1] = tree.FindNearestsK(twoobject[1].transform.position, 16);
